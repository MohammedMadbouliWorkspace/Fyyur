...
Revision ID: 822feb850778
Revises: 
Create Date: 2020-07-16 19:29:58.624388
...
def upgrade():
    ...
    sa.Column('genres', sa.ARRAY(sa.Enum('Alternative', 'Blues', 'Classical', 'Country', 'Electronic', 'Folk', 'Funk', 'Hip_Hop', 'Heavy_Metal', 'Instrumental', 'Jazz', 'Musical_Theatre', 'Pop', 'Punk', 'R_and_B', 'Reggae', 'Rock_n_Roll', 'Soul', 'Other', name='genres')), nullable=False),
